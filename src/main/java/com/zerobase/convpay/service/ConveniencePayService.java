...
/*
예외 상황이 계속 추가되거나 변동되는 상황이 생길수도 있기 때문에
예외 케이스 들을 앞으로 빼서 실패하는 경우를 먼저 거르고
성공하는 단 하나의 케이스를 제일 뒤에 가져다 둠
...
public class ConveniencePayService {
    ...
    public PayCancelResponse payCancel(PayCancelRequest payCancelRequest) {
        ...
        CancelPaymentResult cancelPaymentResult =
                paymentInterface.cancelPayment(
        ...
        // Success Case
        return new PayCancelResponse(
                PayCancelResult.PAY_CANCEL_SUCCESS,
                payCancelRequest.getPayCancelAmount()
        );
    }
}
